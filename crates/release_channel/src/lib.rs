...
pub fn app_identifier() -> &'static str {
    match *RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Aya-Vakfi-Dev",
        ReleaseChannel::Nightly => "Aya-Vakfi-Nightly",
        ReleaseChannel::Preview => "Aya-Vakfi-Preview",
        ReleaseChannel::Stable => "Aya-Vakfi",
    }
}
...
impl ReleaseChannel {
    ...
    pub fn display_name(&self) -> &'static str {
        match self {
            ReleaseChannel::Dev => "AYA Vakfı Dev",
            ReleaseChannel::Nightly => "AYA Vakfı Nightly",
            ReleaseChannel::Preview => "AYA Vakfı Preview",
            ReleaseChannel::Stable => "AYA Vakfı",
        }
    }
    ...
    pub fn app_id(&self) -> &'static str {
        match self {
            ReleaseChannel::Dev => "org.ayavakfi.Aya-Dev",
            ReleaseChannel::Nightly => "org.ayavakfi.Aya-Nightly",
            ReleaseChannel::Preview => "org.ayavakfi.Aya-Preview",
            ReleaseChannel::Stable => "org.ayavakfi.Aya",
        }
    }
